...
``python setup.py test``. Optionally you can run the full suite of tests
which require some additional dependencies by adding the flags
``--addopts --installation`` to the previous command. Tests will also be
