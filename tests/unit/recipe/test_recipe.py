...
TEST_ALLOW_SKIPPING = [
    (VAR_A, {"skip_nonexistent": False}, False),
    (VAR_A, {"skip_nonexistent": True}, True),
    (VAR_A_REF_A, {"skip_nonexistent": False}, False),
    (VAR_A_REF_A, {"skip_nonexistent": True}, False),
    (VAR_A_REF_B, {"skip_nonexistent": False}, False),
    (VAR_A_REF_B, {"skip_nonexistent": True}, True),
]
        ...
        [
            pyesgf.search.results.FileResult(
                json={
                    ...
                    "size": 4745571,
                    "source_id": ["EC-Earth3"],
                    "title": "tas_Amon_EC-Earth3_historical_r1i1p1f1_gr_185001-185012.nc",
                    "url": [
            ...
            pyesgf.search.results.FileResult(
                {
                    ...
                    "size": 4740192,
                    "source_id": ["EC-Earth3"],
                    "title": "tas_Amon_EC-Earth3_historical_r1i1p1f1_gr_185101-185112.nc",
                    "url": [
                        "http://esgf-data1.llnl.gov/thredds/fileServer/css03_data"
                        "/CMIP6/CMIP/EC-Earth-Consortium/EC-Earth3/historical"
                        "/r1i1p1f1/Amon/tas/gr/v20200310/tas_Amon_EC-Earth3"
...
def test_update_multiproduct_multi_model_statistics():
    ...
    for product in output:
        ...
        if "MultiModelStd_Dev" in str(product.filename):
            ...
            assert (
                product.attributes["multi_model_statistics"]
                == "MultiModelStd_Dev"
            )
...
TEST_GET_TASKS_TO_RUN = [
    ...
    (
        {"d4/s1", "d4/s2"},
        {"d4/s1", "d1/pr", "d1/tas", "d4/s2", "d4/pr", "d4/tas"},
    ),
    (
        {"d4/s3", "d3/ta"},
        {"d4/s3", "d3/s1", "d2/s1", "d1/pr", "d1/s1", "d3/ta"},
    ),
]
