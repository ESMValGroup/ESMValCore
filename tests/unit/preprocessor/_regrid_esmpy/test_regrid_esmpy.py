...
@mock.patch(
    "esmvalcore.preprocessor._regrid_esmpy.MASK_REGRIDDING_MASK_VALUE",
    MASK_REGRIDDING_MASK_VALUE,
)
@mock.patch(
    "esmvalcore.preprocessor._regrid_esmpy.ESMF_REGRID_METHODS",
    ESMF_REGRID_METHODS,
)
...
class TestHelpers(tests.Test):
    ...
    def test_coords_iris_to_esmpy_1d_circular(self):
        ...
        (esmpy_lat, esmpy_lon, esmpy_lat_corners, esmpy_lon_corners) = (
            coords_iris_to_esmpy(self.lat_1d, self.lon_1d, True)
        )
    ...
    def test_coords_iris_to_esmpy_1d_non_circular(self):
        ...
        (esmpy_lat, esmpy_lon, esmpy_lat_corners, esmpy_lon_corners) = (
            coords_iris_to_esmpy(self.lat_1d, self.lon_1d, False)
        )
        self.assert_array_equal(esmpy_lat, self.expected_esmpy_lat)
        self.assert_array_equal(esmpy_lon, self.expected_esmpy_lon)
        self.assert_array_equal(
    ...
    def test_coords_iris_to_esmpy_2d_circular(self):
        ...
        (esmpy_lat, esmpy_lon, esmpy_lat_corners, esmpy_lon_corners) = (
            coords_iris_to_esmpy(self.lat_2d, self.lon_2d, True)
        )
        self.assert_array_equal(esmpy_lat, self.expected_esmpy_lat)
        self.assert_array_equal(esmpy_lon, self.expected_esmpy_lon)
        self.assert_array_equal(
    ...
    def test_coords_iris_to_esmpy_2d_non_circular(self):
        ...
        (esmpy_lat, esmpy_lon, esmpy_lat_corners, esmpy_lon_corners) = (
            coords_iris_to_esmpy(self.lat_2d, self.lon_2d, False)
        )
        self.assert_array_equal(esmpy_lat, self.expected_esmpy_lat)
        self.assert_array_equal(esmpy_lon, self.expected_esmpy_lon)
        self.assert_array_equal(
    ...
    @mock.patch(
        "esmvalcore.preprocessor._regrid_esmpy.cube_to_empty_field",
    ...
    def test_build_regridder_2d_masked_data(self, mock_regrid):
        ...
        build_regridder_2d(src_rep, dst_rep, regrid_method, 0.99)
        expected_calls = [
            mock.call(
    ...
    def test_regridder_2d_unmasked_data(self, mock_regrid):
        ...
        regridder = build_regridder_2d(src_rep, dst_rep, regrid_method, 0.99)
    ...
    @mock.patch(
        "esmvalcore.preprocessor._regrid_esmpy.get_grid_representant",
    ...
    @mock.patch(
        "esmvalcore.preprocessor._regrid_esmpy.get_grid_representants",
        mock.Mock(side_effect=identity),
    )
    def test_regrid_nearest(self, mock_build_regridder, mock_map_slices):
    ...
    def test_regrid_linear(self, mock_build_regridder, mock_map_slices):
        """Test full regrid method."""
        mock_build_regridder.return_value = mock.sentinel.regridder
        mock_map_slices.return_value = mock.sentinel.regridded
    ...
    def test_regrid_area_weighted(self, mock_build_regridder, mock_map_slices):
        """Test full regrid method."""
        mock_build_regridder.return_value = mock.sentinel.regridder
        mock_map_slices.return_value = mock.sentinel.regridded
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ESMPyNearest(), "ESMPyNearest(mask_threshold=0.99)"),
    ],
)
def test_scheme_repr(scheme, output):
    """Test ``_ESMPyScheme.__repr__``."""
    assert scheme.__repr__() == output
