...
def test_esgf_search_files(mocker):
    ...
    dkrz_url = (
        "http://esgf2.dkrz.de/thredds/fileServer/lta_dataroot/cmip5/"
...
def test_select_by_time_nodate():
    dataset_id = "cmip3.MIROC.miroc3_2_hires.historical.mon.atmos.run1.tas.v1"
    dataset_id_template = (
...
def test_invalid_dataset_id_template():
    dataset_id = "obs4MIPs.IUP.XCH4_CRDP3.xch4.mon.v100"
    dataset_id_template = (
