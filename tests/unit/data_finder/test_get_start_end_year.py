...
class TestGetStartEndYear(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.var_emac = {
            'project': 'EMAC',
            'dataset': 'historical',
            'data_finder': '_emac/_data_finder.py',
        }

    def test_one_year_emac(self):
        """Test default style for EMAC."""
        start, end = get_start_end_year('historical_____198001_channel',
                                        self.var_emac)
    ...
    def test_years_emac(self):
        """Test default style for EMAC."""
        start, end = get_start_end_year('historical_198001-200001_channel',
                                        self.var_emac)
        self.assertEqual(1980, start)
    ...
    def test_start_and_date_in_name_cmip5(self):
        ...
        start, end = get_start_end_year(
            '19800101_var_control-1950_whatever.nc', self.var_cmip5)
        self.assertEqual(1980, start)
        self.assertEqual(1980, end)
    ...
    def test_end_and_date_in_name_cmip5(self):
        ...
        start, end = get_start_end_year(
            'var_control-1950_whatever_19800101.nc', self.var_cmip5)
        self.assertEqual(1980, start)
        self.assertEqual(1980, end)
