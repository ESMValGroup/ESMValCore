...
def _get_fix(mip, short_name, fix_name, session=None):
    """Load a fix from esmvalcore.cmor._fixes.oras5.oras5."""
    dataset = Dataset(
        project="ORAS5",
        dataset="ORAS5",
        mip=mip,
...
def get_fix(mip, short_name, session=None):
    """Load a variable fix from esmvalcore.cmor._fixes.oras5.oras5."""
...
def get_allvars_fix(mip, short_name, session=None):
    """Load the AllVars fix from esmvalcore.cmor._fixes.oras5.oras5."""
...
#     assert cube.coords("depth")
#     height = cube.coord("depth")
#     assert height.var_name == "depth"
#     assert height.standard_name == "depth"
#     assert height.long_name == "depth"
#     assert height.units == "m"
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "fx", "areacella")
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Ofx", "areacello")
#     assert fix == [AllVars(None), GenericFix(None)]
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "clwvi")
...
#     fixed_cubes = fix_metadata(cubes, "Omon", "clwvi")
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "AERmon", "lwp")
#     assert fix == [AllVars(None), GenericFix(None)]
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "rsdt")
#     assert fix == [AllVars(None), GenericFix(None)]


# def test_rsdt_fix(cubes_2d):
#     """Test fix."""
#     fix = get_allvars_fix("Omon", "rsdt")
#     fixed_cubes = fix.fix_metadata(cubes_2d)
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "rsut")
#     assert fix == [AllVars(None), GenericFix(None)]


# def test_rsut_fix(cubes_2d):
#     """Test fix."""
#     fix = get_allvars_fix("Omon", "rsut")
#     fixed_cubes = fix.fix_metadata(cubes_2d)
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "SImon", "siconc")
#     assert fix == [AllVars(None), GenericFix(None)]
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "SImon", "siconca")
#     assert fix == [AllVars(None), GenericFix(None)]
...
#     cubes = CubeList(
#         [
#             cubes_3d.extract_cube(NameConstraint(var_name="thetao")),
...
#     cube = cubes_2d.extract_cube(NameConstraint(var_name="sosstsst"))
...
#     height_coord = AuxCoord(2.0, var_name="h", standard_name="depth")
#     cube = cubes_2d.extract_cube(NameConstraint(var_name="sosstsst"))
...
#     cube = cubes_2d.extract_cube(NameConstraint(var_name="sosstsst"))
#     cube.add_aux_coord(height_coord, ())
#     cube = iris.util.new_axis(cube, scalar_coord="depth")
...
#     assert "oras5_grid.nc" in fix._horizontal_grids
#     original_grid = fix._horizontal_grids["oras5_grid.nc"].copy()

#     # Make sure that fix does not alter existing grid
#     fix.fix_metadata(cubes_2d)
#     assert fix._horizontal_grids["oras5_grid.nc"] == original_grid
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "uas")
#     assert fix == [AllVars(None), GenericFix(None)]


# def test_uas_fix(cubes_2d):
#     """Test fix."""
#     fix = get_allvars_fix("Omon", "uas")
#     fixed_cubes = fix.fix_metadata(cubes_2d)
...
#     # Scalar height (with wrong metadata) already present
#     height_coord = AuxCoord(10.0, var_name="h", standard_name="depth")
...
#     assert cube.coords("depth", dim_coords=False, dimensions=())
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "ch4Clim")
#     assert fix == [AllVars(None), GenericFix(None)]
...
#     fix = get_allvars_fix("Omon", "ch4Clim")
#     fixed_cubes = fix.fix_metadata(cubes_regular_grid)
...
def test_add_time(cubes_2d, cubes_3d):
    ...
    tas_cube = cubes_2d.extract_cube(NameConstraint(var_name="sosstsst"))
    thetao_cube = cubes_3d.extract_cube(NameConstraint(var_name="votemper"))
    tas_cube = tas_cube[0]
    tas_cube.remove_coord("time")
    cubes = CubeList([tas_cube, thetao_cube])
...
# @mock.patch.object(Oras5Fix, "_get_grid_from_facet", autospec=True)
# @mock.patch("esmvalcore.cmor._fixes.oras5._base_fixes.requests", autospec=True)
...
#     (tmp_path / "omip").mkdir(parents=True, exist_ok=True)
#     iris.save(grid_cube, tmp_path / "omip" / "grid.nc")
...
#     # Save temporary grid file
#     grid_cube = Cube(0, var_name="grid")
#     iris.save(grid_cube, str(tmp_path / "oras5_grid.nc"))
...
# def test_only_depth(monkeypatch):
#     """Test fix."""
#     fix = get_allvars_fix("Omon", "thetao")
#     # We know that ta has dimensions time, plev19, latitude, longitude, but the
#     # ICON CMORizer is designed to check for the presence of each dimension
...
#         [1000.0, 100.0], var_name="depth", standard_name="depth", units="cm"
#     )
#     cubes = CubeList(
#         [
#             Cube(
...
#     assert cube.coords("depth", dim_coords=True)
#     new_height_coord = cube.coord("depth")
#     assert new_height_coord.var_name == "depth"
#     assert new_height_coord.standard_name == "depth"
#     assert new_height_coord.long_name == "depth"
...
# @mock.patch("esmvalcore.cmor._fixes.oras5._base_fixes.logger", autospec=True)
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "hfls")
...
#     fixed_cubes = fix_metadata(cubes, "Omon", "hfls")
...
#     fixed_cube = fix_data(cube, "Omon", "hfls")
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "hfss")
...
#     fixed_cubes = fix_metadata(cubes, "Omon", "hfss")
...
#     fixed_cube = fix_data(cube, "Omon", "hfss")
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "rtnt")
...
#     fixed_cubes = fix_metadata(cubes, "Omon", "rtnt")
...
#     """Test getting of fix."""
#     fix = Fix.get_fixes("ORAS5", "ORAS5", "Omon", "rtmt")
...
#     fixed_cubes = fix_metadata(cubes, "Omon", "rtmt")
