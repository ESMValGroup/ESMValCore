...
def test_add_pressure_level_coordinate(cube, output):
    """Test adding of pressure level coordinate."""
    if output is None:
        with pytest.raises(ValueError) as err:
            add_pressure_level_coordinate(cube)
        msg = ("Cannot add 'air_pressure' coordinate, 'altitude' or "
