...
from esmvalcore.cmor._fixes.cmip6.cmcc_cm2_vhr4 import Ofx, Omon
...
def test_get_omon_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('CMIP6', 'CMCC-CM2-VHR4', 'Omon', 'tos')
    assert Omon(None) in fixes


def test_get_ofx_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('CMIP6', 'CMCC-CM2-VHR4', 'Ofx', 'areacello')
