...
from esmvalcore.cmor._fixes.cmip6.ec_earth3_aerchem import Ofx, Omon
...
def test_get_omon_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('CMIP6', 'EC-Earth3-AerChem', 'Omon', 'tos')
...
def test_get_ofx_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('CMIP6', 'EC-Earth3-AerChem', 'Ofx', 'areacello')
