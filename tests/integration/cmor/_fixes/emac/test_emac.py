...
def test_get_clwvi_fix():
    ...
    assert fix == [Clwvi(None), AllVars(None), AutomaticFix(None)]
...
def test_get_evspsbl_fix():
    ...
    assert fix == [Evspsbl(None), AllVars(None), AutomaticFix(None)]
...
def test_get_hfls_fix():
    ...
    assert fix == [Hfls(None), AllVars(None), AutomaticFix(None)]
...
def test_get_hfss_fix():
    ...
    assert fix == [Hfss(None), AllVars(None), AutomaticFix(None)]
...
def test_get_od550aer_fix():
    ...
    assert fix == [Od550aer(None), AllVars(None), AutomaticFix(None)]
...
def test_get_pr_fix():
    ...
    assert fix == [Pr(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rlds_fix():
    ...
    assert fix == [Rlds(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rlus_fix():
    ...
    assert fix == [Rlus(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rlut_fix():
    ...
    assert fix == [Rlut(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rlutcs_fix():
    ...
    assert fix == [Rlutcs(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rsds_fix():
    ...
    assert fix == [Rsds(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rsdt_fix():
    ...
    assert fix == [Rsdt(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rsus_fix():
    ...
    assert fix == [Rsus(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rsut_fix():
    ...
    assert fix == [Rsut(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rsutcs_fix():
    ...
    assert fix == [Rsutcs(None), AllVars(None), AutomaticFix(None)]
...
def test_get_rtmt_fix():
    ...
    assert fix == [Rtmt(None), AllVars(None), AutomaticFix(None)]
...
def test_get_sithick_fix():
    ...
    assert fix == [Sithick(None), AllVars(None), AutomaticFix(None)]
...
def test_get_toz_fix():
    ...
    assert fix == [Toz(None), AllVars(None), AutomaticFix(None)]
...
def test_get_MP_BC_tot_fix():  # noqa: N802
    ...
    assert fix == [MP_BC_tot(None), AllVars(None), AutomaticFix(None)]
...
def test_get_MP_DU_tot_fix():  # noqa: N802
    ...
    assert fix == [MP_DU_tot(None), AllVars(None), AutomaticFix(None)]
...
def test_get_MP_SO4mm_tot_fix():  # noqa: N802
    ...
    assert fix == [MP_SO4mm_tot(None), AllVars(None), AutomaticFix(None)]
...
def test_get_MP_SS_tot_fix():  # noqa: N802
    ...
    assert fix == [MP_SS_tot(None), AllVars(None), AutomaticFix(None)]
...
def test_get_zg_fix():
    ...
    assert fix == [Zg(None), AllVars(None), AutomaticFix(None)]
