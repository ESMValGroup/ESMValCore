...
from esmvalcore.cmor._fixes.cmip5.gfdl_cm3 import Sftof, AllVars, Areacello
...
class TestSftof(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertListEqual(
            Fix.get_fixes('CMIP5', 'GFDL-CM3', 'sftof'), [AllVars(), Sftof()])
...
class TestAreacello(unittest.TestCase):
    ...
    def test_get(self):
        """Test fix get"""
        self.assertListEqual(
            Fix.get_fixes('CMIP5', 'GFDL-CM3', 'areacello'),
            [AllVars(), Areacello()])
