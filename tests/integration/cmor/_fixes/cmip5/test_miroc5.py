...
def test_get_hur_fix():
    ...
    assert fix == [Hur(None), GenericFix(None)]
...
class TestSftof(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertListEqual(
            Fix.get_fixes("CMIP5", "MIROC5", "Amon", "sftof"),
            [Sftof(None), GenericFix(None)],
        )
...
class TestTas(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.coord = iris.coords.DimCoord(
            [3.141592],
    ...
    def test_get(self):
        """Test fix get."""
        self.assertListEqual(
            Fix.get_fixes("CMIP5", "MIROC5", "Amon", "tas"),
