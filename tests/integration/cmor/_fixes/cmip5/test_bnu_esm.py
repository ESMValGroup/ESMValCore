...
class TestCo2(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertListEqual(
            Fix.get_fixes("CMIP5", "BNU-ESM", "Amon", "co2"),
    ...
    def test_fix_data(self):
        """Test fix values."""
        cube = self.fix.fix_data(self.cube)
        self.assertEqual(cube.data[0], 29.0 / 44.0 * 1.0e6)
...
class TestCh4(unittest.TestCase):
    ...
    def test_get(self):
        """Test fix get."""
        self.assertListEqual(
            Fix.get_fixes("CMIP5", "BNU-ESM", "Amon", "ch4"),
    ...
    def test_fix_data(self):
        """Test data fix."""
        cube = self.fix.fix_data(self.cube)
        self.assertEqual(cube.data[0], 29.0 / 16.0 * 1.0e9)
        self.assertEqual(cube.units, Unit("J"))
...
class TestOd550Aer(unittest.TestCase):
    ...
    def setUp(self):
        """Prepare tests."""
        self.cube = Cube(
            ma.MaskedArray([1.0e36], mask=(False,)),
            var_name="od550aer",
        )
