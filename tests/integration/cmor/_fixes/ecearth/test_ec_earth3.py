...
from esmvalcore.cmor._fixes.cmip6.ec_earth3 import Ofx, Omon
...
def test_get_omon_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('ECEARTH', 'EC-Earth3', 'Omon', 'tos')
...
def test_get_ofx_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('ECEARTH', 'EC-Earth3', 'Ofx', 'areacello')
