...
from esmvalcore.cmor._fixes.cmip6.ec_earth3p_vhr import Ofx, Omon
...
def test_get_omon_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('ECEARTH', 'EC-Earth3P-VHR', 'Omon', 'tos')
...
def test_get_ofx_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('ECEARTH', 'EC-Earth3P-VHR', 'Ofx', 'areacello')
