"""Tests for EC-Earth3-CC."""
from esmvalcore.cmor._fixes.common import NemoGridFix
from esmvalcore.cmor._fixes.ecearth.ec_earth3_cc import Ofx, Omon
from esmvalcore.cmor.fix import Fix


def test_get_omon_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('ECEARTH', 'EC-Earth3-CC', 'Omon', 'tos')
...
def test_get_ofx_fix():
    """Test getting of fix."""
    fixes = Fix.get_fixes('ECEARTH', 'EC-Earth3-CC', 'Ofx', 'areacello')
