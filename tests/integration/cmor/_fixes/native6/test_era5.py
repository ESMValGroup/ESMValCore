...
def _cmor_time(mip, bounds=None, shifted=False):
    ...
    return DimCoord(np.array(timestamps, dtype=float),
                    standard_name='time',
                    long_name='time',
                    var_name='time',
...
VARIABLES = [
    pytest.param(a, b, c, d, id=c + '_' + d) for (a, b, c, d) in [
        ...
        (era5_3d('monthly'), cmor_3d('Emon', 'rainmxrat27'), 'rainmxrat27',
         'Emon'),
        ...
        (era5_3d('monthly'), cmor_3d('Emon', 'snowmxrat27'), 'snowmxrat27',
         'Emon'),
