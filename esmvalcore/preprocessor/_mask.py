...
def mask_above_threshold(cube, threshold):
    ...
    iris.cube.Cube
        thresholded cube.
    """
    cube.data = da.ma.masked_where(cube.data > threshold, cube.data)
    return cube
...
def mask_inside_range(cube, minimum, maximum):
    ...
    iris.cube.Cube
        thresholded cube.
    """
    cube.data = da.ma.masked_inside(cube.data, minimum, maximum)
    return cube
...
def mask_outside_range(cube, minimum, maximum):
    ...
    iris.cube.Cube
        thresholded cube.
    """
    cube.data = da.ma.masked_outside(cube.data, minimum, maximum)
    return cube
