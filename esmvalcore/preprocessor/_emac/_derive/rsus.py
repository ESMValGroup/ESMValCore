...
"""The variable 'rsus' (Surface Upwelling Shortwave Radiation) is stored in """
"""the EMAC variable 'sradsu_ave',"""
...
def derive(cubes):
    rsus_cube = -1. * cubes.extract_strict(var_name_constraint('sradsu_ave'))
