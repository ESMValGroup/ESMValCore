...
def load_cmor_tables(cfg: Config) -> None:
    ...
    for project in cfg["projects"]:
        CMOR_TABLES[project] = get_table(cfg, project)
...
class CMIP6Info(InfoBase):
    ...
    paths:
        ...
        :ref:`esmvalcore/cmor/tables <https://github.com/ESMValGroup/ESMValCore/tree/main/esmvalcore/cmor/tables>`__
...
class CustomInfo(CMIP5Info):
    ...
    def __init__(self, cmor_tables_path: str | Path | None = None) -> None:
        ...
        self.paths = (Path(self._get_cmor_path("custom")),)
