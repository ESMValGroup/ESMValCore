...
class Config(ValidatedConfig):
    ...
    clear = ValidatedConfig.clear  # to show this is API doc

    context = ValidatedConfig.context  # to show this is API doc

    copy = ValidatedConfig.copy  # to show this is API doc
